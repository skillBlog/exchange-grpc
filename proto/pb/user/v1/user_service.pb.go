...
// GetUserRequest — user_id извлекается из JWT/metadata.
...
const file_user_v1_user_service_proto_rawDesc = "" +
	...
	"\x06Logout\x12\x16.user.v1.LogoutRequest\x1a\x17.user.v1.LogoutResponseB2Z0github.com/exchange-grpc/proto/pb/user/v1;userv1b\x06proto3"
